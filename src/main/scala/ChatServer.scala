...
// TODO make private chats and add in memory storage
object ChatServer extends App{
  ...
  class ChatServer extends Actor {
    private var clients = scala.collection.mutable.Map[ActorRef, String]()
    ...
    def broadcast(msg:Message) = {
      clients.foreach(x => x._1 ! msg)
    }

    def getUsername(actor:ActorRef):String = {
       clients.getOrElse(actor, "Anonymous")
    }
  }
